    ...
    return {
        uploadExcel: function () {
            ...
            const oUploadButton = new Button({
                ...
                press: () => {
                    ...
                    oReader.onload = async (e) => {
                        ...
                        try {
                            const response = await fetch("/odata/v4/price-list/MassUploadTileContent", {
                                method: "POST",
            ...
            const oDownloadButton = new Button({
                text: "Download Tile Content Template",
                press: () => {
                    const aColumns = [
                        ...
                        { label: "InformationHeading", property: "InformationHeading" },
                        { label: "InformationDetails", property: "InformationDetails" },
                        { label: "ImageLink", property: "ImageLink" }
                    ];
                    const oSettings = {
                        workbook: { columns: aColumns },
                        dataSource: [{}],
                        fileName: "TileContentTemplate.xlsx"
                    };
